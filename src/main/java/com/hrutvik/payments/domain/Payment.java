...
public class Payment {
  ...
  protected Payment() {}
  public Payment(UUID id, String key, String merchantId, BigDecimal amount, String currency) {
    this.id=id; this.idempotencyKey=key; this.merchantId=merchantId; this.amount=amount;
  ...
  public UUID getId(){return id;} public String getIdempotencyKey(){return idempotencyKey;} public String getMerchantId(){return merchantId;}
